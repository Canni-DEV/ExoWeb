...
4. Nubes a resolución reducida en una rejilla sin jitter de cámara: ruido 3D precalculado, erosión y perfiles verticales; salida de radiancia, opacidad y profundidad media ponderada por contribución. Los intervalos del trazado dependen de la capa atmosférica; la geometría recorta el último intervalo sin desplazar todos los anteriores. El muestreo estratificado es estable por píxel. Su campo de densidad también atenúa la luz solar del suelo y del agua.
5. Reproyección de nubes con cámara y viento, usando matrices sin jitter, rechazo por profundidad y limitación del historial. El filtro espacial comprueba profundidad antes de mezclar colores.
6. Oclusión de contacto y resolución temporal de la escena sin nubes: jitter Halton, vectores, rechazo por profundidad y limitación por vecindad. Se compensa el desplazamiento de la muestra actual y se eliminan los desplazamientos actual/anterior de los vectores para reconstruir en una rejilla de salida estable. Motion blur usa ese movimiento físico corregido.
7. Ampliación de nubes mediante muestras individuales de color/profundidad y composición premultiplicada; se validan antes de interpolar para evitar contaminación del cielo sobre el relieve. No se vuelven a acumular dentro del TAA de escena.
